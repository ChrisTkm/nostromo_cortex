...
export function getTaskEditorHtml(webview: vscode.Webview, extensionUri: vscode.Uri, nonce: string) {
  const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, "media", "task-editor.js"));
  const styleUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, "media", "task-editor.css"));
  ...
  <html lang="en" data-cortex-theme="${theme}">
    <head>
      ...
      <title>Cortex Task Editor</title>
